...
**NOTE**: *You can call your geonode project whatever you like following the naming conventions for python packages (generally lower case with underscores (``_``). In the examples below, replace ``gret_geonode`` with whatever you would like to name your project.*
...
1. Prepare the Environment
    ...
    mkvirtualenv --python=/usr/bin/python3 gret_geonode
    pip install Django==2.2.12

    django-admin startproject --template=./geonode-project -e py,sh,md,rst,json,yml,ini,env,sample -n monitoring-cron -n Dockerfile gret_geonode
